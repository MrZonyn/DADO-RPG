function rollDie(sides: number): void {
  const modifierInput = document.querySelector<HTMLInputElement>(".plus");
...
function addRollToHistory(
  ...
  const historyContainer =
    document.querySelector<HTMLDivElement>(".dice-result");
  ...
  if (isFumble) entry.classList.add("fumble");
